...
const FALLBACK_ACTIVE_SYMBOLS = [
    { symbol: 'R_10', underlying_symbol: 'R_10', display_name: 'Volatility 10 Index', market: 'synthetic_index', market_display_name: 'Derived', submarket: 'random_index', submarket_display_name: 'Continuous Indices', pip: 0.001, pip_size: 0.001, exchange_is_open: true, is_trading_suspended: false },
    { symbol: 'R_25', underlying_symbol: 'R_25', display_name: 'Volatility 25 Index', market: 'synthetic_index', market_display_name: 'Derived', submarket: 'random_index', submarket_display_name: 'Continuous Indices', pip: 0.001, pip_size: 0.001, exchange_is_open: true, is_trading_suspended: false },
    { symbol: 'R_50', underlying_symbol: 'R_50', display_name: 'Volatility 50 Index', market: 'synthetic_index', market_display_name: 'Derived', submarket: 'random_index', submarket_display_name: 'Continuous Indices', pip: 0.0001, pip_size: 0.0001, exchange_is_open: true, is_trading_suspended: false },
    { symbol: 'R_75', underlying_symbol: 'R_75', display_name: 'Volatility 75 Index', market: 'synthetic_index', market_display_name: 'Derived', submarket: 'random_index', submarket_display_name: 'Continuous Indices', pip: 0.0001, pip_size: 0.0001, exchange_is_open: true, is_trading_suspended: false },
    { symbol: 'R_100', underlying_symbol: 'R_100', display_name: 'Volatility 100 Index', market: 'synthetic_index', market_display_name: 'Derived', submarket: 'random_index', submarket_display_name: 'Continuous Indices', pip: 0.01, pip_size: 0.01, exchange_is_open: true, is_trading_suspended: false },
    { symbol: '1HZ10V', underlying_symbol: '1HZ10V', display_name: 'Volatility 10 (1s) Index', market: 'synthetic_index', market_display_name: 'Derived', submarket: 'random_index', submarket_display_name: 'Continuous Indices', pip: 0.001, pip_size: 0.001, exchange_is_open: true, is_trading_suspended: false },
    { symbol: '1HZ50V', underlying_symbol: '1HZ50V', display_name: 'Volatility 50 (1s) Index', market: 'synthetic_index', market_display_name: 'Derived', submarket: 'random_index', submarket_display_name: 'Continuous Indices', pip: 0.0001, pip_size: 0.0001, exchange_is_open: true, is_trading_suspended: false },
    { symbol: '1HZ75V', underlying_symbol: '1HZ75V', display_name: 'Volatility 75 (1s) Index', market: 'synthetic_index', market_display_name: 'Derived', submarket: 'random_index', submarket_display_name: 'Continuous Indices', pip: 0.0001, pip_size: 0.0001, exchange_is_open: true, is_trading_suspended: false },
    { symbol: '1HZ100V', underlying_symbol: '1HZ100V', display_name: 'Volatility 100 (1s) Index', market: 'synthetic_index', market_display_name: 'Derived', submarket: 'random_index', submarket_display_name: 'Continuous Indices', pip: 0.01, pip_size: 0.01, exchange_is_open: true, is_trading_suspended: false },
    { symbol: 'frxEURUSD', underlying_symbol: 'frxEURUSD', display_name: 'EUR/USD', market: 'forex', market_display_name: 'Forex', submarket: 'major_pairs', submarket_display_name: 'Major Pairs', pip: 0.00001, pip_size: 0.00001, exchange_is_open: true, is_trading_suspended: false },
    { symbol: 'frxGBPUSD', underlying_symbol: 'frxGBPUSD', display_name: 'GBP/USD', market: 'forex', market_display_name: 'Forex', submarket: 'major_pairs', submarket_display_name: 'Major Pairs', pip: 0.00001, pip_size: 0.00001, exchange_is_open: true, is_trading_suspended: false },
    { symbol: 'frxUSDJPY', underlying_symbol: 'frxUSDJPY', display_name: 'USD/JPY', market: 'forex', market_display_name: 'Forex', submarket: 'major_pairs', submarket_display_name: 'Major Pairs', pip: 0.001, pip_size: 0.001, exchange_is_open: true, is_trading_suspended: false },
];
...
class APIBase {
    ...
    private readonly ACTIVE_SYMBOLS_TIMEOUT_MS = 15000; // 15 seconds
    ...
    async init(force_create_connection = false) {
        ...
        if (!this.api || this.api?.connection.readyState !== 1 || force_create_connection) {
            if (this.api?.connection) {
                ...
                this.api.connection.removeEventListener('error', this.onsocketerror.bind(this));
            }
            ...
            this.api?.connection.addEventListener('error', this.onsocketerror.bind(this));
    ...
    getActiveSymbols = async () => {
        if (!this.api) {
            ...
            this.active_symbols = FALLBACK_ACTIVE_SYMBOLS;
        ...
        try {
            ...
            console.warn('[APIBase] Active symbols fetch issue, applying fallback symbols:', error);
            if (!this.active_symbols || this.active_symbols.length === 0) {
                this.active_symbols = FALLBACK_ACTIVE_SYMBOLS;
            }
            this.has_active_symbols = true;
