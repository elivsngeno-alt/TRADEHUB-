...
import { type DerivAccount,DerivWSAccountsService } from '@/services/derivws-accounts.service';
    ...
    const menu = open && menuPosition && typeof document !== 'undefined'
        ? createPortal(
            ...
            >
                ...
                <div style={{ borderTop: '1px solid var(--site-border, #cbd5e1)', marginTop: 6, paddingTop: 6, display: 'flex', flexDirection: 'column', gap: 4 }}>
                    <button
                        type='button'
                        className='prodb-api-account__choice'
                        onClick={() => {
                            closeMenu();
                            window.location.hash = '#admin';
                        }}
                        style={{ justifyContent: 'flex-start', color: '#10b981', fontWeight: 700 }}
                    >
                        <span>🛡</span>
                        <span className='prodb-api-account__choice-copy'>
                    ...
                    <button
                        ...
                        onClick={() => {
                            closeMenu();
                            OAuthTokenExchangeService.clearStoredTokens();
                    ...
                    >
                        <span>🚪</span>
                        <span className='prodb-api-account__choice-copy'>
                            <strong>Lock / Sign Out</strong>
                            <small>Return to Gateway</small>
                        </span>
                    </button>
                </div>
