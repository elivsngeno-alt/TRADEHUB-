...
export const ShieldIcon = (p: SVGProps<SVGSVGElement>) => <Icon {...p}><path d='M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z' /></Icon>;
export const LockIcon = (p: SVGProps<SVGSVGElement>) => <Icon {...p}><rect x='3' y='11' width='18' height='11' rx='2' ry='2' /><path d='M7 11V7a5 5 0 0 1 10 0v4' /></Icon>;
