...
const ContractCardDialog = React.forwardRef(
    (
        ...
        const node_ref = React.useRef<HTMLDivElement>(null);
        const dialog_ref = (ref as React.RefObject<HTMLDivElement>) || node_ref;

        useOnClickOutside(dialog_ref, toggleDialog, validateClickOutside);
