...
const ContractCardHeader = ({
    ...
    const sell_button_node_ref = React.useRef<HTMLDivElement>(null);
                ...
                <MobileWrapper>
                    {is_valid_to_sell ? (
                        <CSSTransition
                            ...
                            unmountOnExit
                        >
                            <div ref={sell_button_node_ref} className='dc-contract-card__sell-button-mobile'>
                                <Button
